...
<?
	if (!empty($arItem['MIN_PRICE']))
	{
		...
		{
?>
					<div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_slider_current_price">
<?
			echo GetMessage(
...
<?
	...
	{
?>
					<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bt_blue big shadow cart"><span></span><strong><?
...
<?
	...
	{
?>
					<a id="<? echo $arItemIDs['BUY_LINK']; ?>" href="javascript:void(0)" rel="nofollow" class="bt_blue big shadow cart"><span></span><strong><?
